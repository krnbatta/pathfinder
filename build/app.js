...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _component3 = __webpack_require__(7);
	...
	var _component7 = __webpack_require__(11);
	
	var _component8 = _interopRequireDefault(_component7);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var Components = [_component2.default, _component4.default, _component6.default, _component8.default];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _mapParser = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./mapParser\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	
	var _mapParser2 = _interopRequireDefault(_mapParser);
	
	var _raphael = __webpack_require__(5);
	
	var _raphael2 = _interopRequireDefault(_raphael);
	
	var _Map = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./models/Map\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	
	var _Map2 = _interopRequireDefault(_Map);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var DebuggerComponent = $.extend(Component, {
	
	  methods: {
	    onLeaveNone: function onLeaveNone() {
	      $("#path-component").html(_template2.default);
	      this.bindEvents();
	    },
	    bindEvents: function bindEvents() {
	      var _this = this;
	
	      $(".path_component__load_algo").on('change', function (e) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var MapComponent = $.extend(Component, {
	  ...
	  methods: {
	    ...
	    bindEvents: function bindEvents() {
	      ...
	      $(".path_component__load_map").on('change', function (e) {
	    ...
	    drawMap: function drawMap() {
	      this.map.mapNodes.then(function (nodes) {
...
/***/ (function(module, exports) {
	...
	var StatsComponent = $.extend(Component, function () {});
